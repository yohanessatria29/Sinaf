    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Input Data Verifikator</h4>
            </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nik" name="nik" onchange="checknikverifikator(this.value, this.id)" placeholder="Masukkan NIK"  required>
                        </div>
