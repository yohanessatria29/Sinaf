...
<body>
                ...
                <div class="container">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Edit Data Verifikator</h4>
                        </div>
                        <?php echo form_open_multipart('Pengajuan/simpanVerifikator') ?>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nik" name="nik" onchange="checknikverifikator(this.value, this.id)" placeholder="Masukkan NIK" value="<?= $data[0]['nik'] ?>" readonly>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="email" name="email" placeholder="Masukkan Email" onchange="checkemail(this.value, this.id)" value="<?= $data[0]['email'] ?>" readonly>
                                        </div>
    ...
    <script>
        ...
        function checknikverifikator(val, inputbox) {
            // alert("The input value has changed. The new value is: " + val);
            var base_url = window.location.origin;
            var username = encodeURIComponent(val);
            var id_inputbox = document.getElementById(inputbox);
            ...
            $.ajax({
                url: base_url + '/pengajuan/checknikverifikator/' + username,
                type: 'get',
                success: function(response) {
                    // alert(response);
                    $(this).val = "";
