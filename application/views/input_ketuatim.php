...
<head>
    ...
    <title>User Ketua Tim Kerja</title>
        ...
        <div class="container">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Input Data Ketua Tim Kerja</h4>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nik" name="nik" placeholder="Masukkan NIK" onchange="checknikketua(this.value, this.id)" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="helperText">Tanggal Mulai Aktif Sebagai Ketua Tim</label>
                                    <div class="row">
                                        <div class="col-md-4">
