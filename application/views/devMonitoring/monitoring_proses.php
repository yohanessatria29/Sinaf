                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if (isset($data['kemampuan_pelayanan'])) {
                                                                echo $data['kemampuan_pelayanan'];
                                                            } ?>
                                                        </td>
                                                        <td><?= $data['lpa']; ?></td>
                                                        ...
                                                        <td>
                                                            <?php
                                                            // var_dump($tanggal_survei);
                                                            // $date = date_create($tanggal_survei[0]);
                                                        ...
                                                        <td>
                                                            <?php
                                                            // echo $tanggal_survei[1];
                                                            // $date = date_create($tanggal_survei[1]);
                                                        ...
                                                        <td>
                                                            <?php
                                                            // echo (!empty($tanggal_survei[2]) ? $tanggal_survei[2] : '');
