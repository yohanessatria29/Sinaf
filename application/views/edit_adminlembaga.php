...
<body>
    ...
    $fasyankes_id = $data[0]['fasyankes_id'];
    ?>
                ...
                <div class="container">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">Edit Data Admin Lembaga</h4>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nik" name="nik" onchange="checknikadmin(this.value, this.id)" placeholder="Masukkan NIK" value="<?= $data[0]['nik'] ?>" disabled>
                                        ...
                                        <div class="form-group col-md-12">
                                            <div class="form-group col-md-6">
                                                <label for="helperText">Surat Keputusan Penugasan</label>
    ...
    <script>
        function checknama(val, inputbox) {
            ...
            $.ajax({
                url: base_url + 'user/checknama/' + username,
                type: 'get',
                success: function(response) {
                    ...
                    if (response > 0) {
                        id_inputbox.value = "";
                        alert('Nama yang digunakan sudah terdaftar !');
                    }
                }
            })
        }
