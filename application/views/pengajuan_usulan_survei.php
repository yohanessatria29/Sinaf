                                ...
                                <form method="post" class="login-form" name="form_validation">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <span>Nama Fasyankes <small style="color: red;">(Sesuai Surat Izin Operasional)</small></span>
                                                <fieldset class="form-group">
                                                    <input type="text" class="form-control" placeholder="nama faskes" id="nama_faskes" value="<?php echo $detail_faskes[0]['nama_faskes']; ?>" readonly>
                                                </fieldset>
                                            </div>

                                            <div class="form-group">
                                                <span>Alamat Fasyankes <small style="color: red;">(tidak menuliskan kecamatan, kab/kota atau provinsi. Contoh: Jl. Merica No. 515 Pondok Cabe)</small></span>
                                                <fieldset class="form-group">
                                                    <input type="text" class="form-control" placeholder="nama faskes" id="alamat_faskes" value="<?php echo $detail_faskes[0]['alamat_faskes']; ?>" readonly>
                                                </fieldset>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <span>Nama LPA</span>
                                                <fieldset class="form-group">
                                                    <input type="text" class="form-control" id="nama_lpa" placeholder="Nama LPA" value="<?php echo $data[0]['lpa']; ?>" readonly>
                                                </fieldset>

                                                <div class="form-group">
                                                    <span>Metode Survei</span>
                                                    <fieldset class="form-group">
                                                ...
                                                <?php if ($data[0]['url_suket_kendala_jaringan'] != NULL) { ?>
                                                    <div class="form-group">
                                                        <span>Surat Keterangan Kendala Jaringan Dinkes Kab/Kota</span>
                                                        <fieldset>
                                                            <div class="input-group">
                                                                <a class="btn btn-primary rounded-pill" id="surat_keterangan_jaringan" target="_blank" href="<?php echo $data[0]['url_suket_kendala_jaringan']; ?>">Lihat Dokumen</a>
                                                            </div>
                                                        </fieldset>
                                                    </div>
                                                <?php
                                                ...
                                                <div class="form-group" style="display:<?= $var_style_usulan ?>" id='pengajuan_usulan_survei'>
                                                    <span>Tanggal Usulan Sebelumnya</span>
                                                    <fieldset class="form-group">
                                                ...
                                                <div class="form-group status" style="display: <?= $var_style_status; ?>" id="status">
                                                    <span>Status Akreditasi Sebelumnya</span>
                                                ...
                                                <div class="form-group" style="display:<?= $var_style_sertifikat ?>">
                                                    <span>Sertifikat Akreditasi Sebelumnya / Surat Penetapan</span>
                                                    <fieldset>
                                                        <div class="input-group">
                                                            <a class="btn btn-primary rounded-pill" target="_blank" id="sertifikat_akreditas" href="<?php echo $data[0]['url_sertifikasi_akreditasi_sebelumnya']; ?>">Lihat Dokumen</a>
                                                        </div>
                                                    </fieldset>
                                                </div>

                                                <div class="form-group" style="display:<?= $var_style_tgl_akhir ?>">
                                                    <span>Tanggal Akhir Sertifikat</span>
                                                    <input type="text" name="tanggal_akhir_sertifikat" id="tanggal_akhir_sertifikat" value="<?= $data[0]['tanggal_akhir_sertifikat'] ?>" class="form-control datepicker" autocomplete="off" disabled>
                                                </div>

                                                <div class="form-group">
                                                    <span>Tanggal Pengajuan Survei</span>
                                                ...
                                                <div class="form-group" style="display:<?= $var_style_tgl_akhir ?>">
                                                    <span>Tanggal Keberangkatan Survei</span>
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <input type="date" name="tanggal_awal_keberangkatan" id="tanggal_awal_keberangkatan" value="<?= $data[0]['tanggal_awal_keberangkatan'] ?>" class="form-control datepicker" autocomplete="off" disabled>
                                                        </div>
                                                        s.d.
                                                        <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <span>Tanggal Rencana Survei</span>
                                                    <div class="row">
                                                        <?php
                                                ...
                                                <div class="form-group" style="display:<?= $var_style_tgl_akhir ?>">
                                                    <span>Tanggal Kepulangan Survei</span>
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <input type="date" name="tanggal_awal_kepulangan" id="tanggal_awal_kepulangan" value="<?= $data[0]['tanggal_awal_kepulangan'] ?>" class="form-control datepicker" autocomplete="off" disabled>
                                                        </div>
                                                        s.d.
                                                        <div class="col-md-4">
                                                            <input type="date" name="tanggal_akhir_kepulangan" id="tanggal_akhir_kepulangan" value="<?= $data[0]['tanggal_akhir_kepulangan'] ?>" class="form-control datepicker" autocomplete="off" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    if (!empty($data[0]['pengiriman_laporan_survei_id'])) {
                                                    ?>
                                                        <?= form_dropdown('status_usulan_id', dropdown_sina_persetujuan_status(), $data[0]['status_usulan_id'], 'id="status_usulan_id" disabled  class="form-select" '); ?>
                                                    <?php
                                                    } else {
                                                    ?>
                                                        <?= form_dropdown('status_usulan_id', dropdown_sina_persetujuan_status(), $data[0]['status_usulan_id'], 'id="status_usulan_id"   class="form-select" '); ?>
                                                    <?php
                                                    }
                                                    ?>
                                                    <? //= //form_dropdown('status_usulan_id', dropdown_sina_status_usulan(), $data[0]['status_usulan_id'], 'id="status_usulan_id"  class="form-select" '); 
                                ...
                                <div class="section">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <?php
                                                    // $url_surat_permohonan_survei = $data[0]['url_surat_permohonan_survei'];
                                                    // // Validate url
                                                    // if (filter_var($url_surat_permohonan_survei, FILTER_VALIDATE_URL) !== false) {
                                                    ?>
                                                    <!-- <a href="<? //= $url_surat_permohonan_survei 
                                                                    ?>" target="_blank"><? //= $url_surat_permohonan_survei 
                                                                                        ?></a> -->
                                                    <?php
                                                    //} else {
                                                    ?>
                                                    <!-- <p class="text-left">
                                                            <? //= $url_surat_permohonan_survei
                                                            ?>
                                                        </p> -->
                                                    <?php
                                                    // }
                                    ...
                                    <div class="form-group col-md-4">
                                        <div class="form-group" style='display:block;'>
                                            <span>Tanggal Kirim Berkas Fasyankes</span>
                                            <input type="text" name="tanggal_kirim_berkas" id="tanggal_kirim_berkas" value="<?= (!empty($data[0]['tgl_edit_berkas']) ? $data[0]['tgl_edit_berkas'] : '') ?>" class="form-control datepicker" autocomplete="off" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <div class="form-group" style='display:block;'>
                                            <span>Tanggal Periksa Berkas</span>
                                            <input type="text" name="tanggal_periksa_berkas" id="tanggal_periksa_berkas" value="<?= (!empty($data[0]['tgl_periksa_berkas']) ? $data[0]['tgl_periksa_berkas'] : '') ?>" class="form-control datepicker" autocomplete="off" disabled>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="page-body">
                                <div class="section">
                                    ...
                                    <div class="form-group col-md-4 mt-4">
                                        <div class="form-group" style='display:block;'>
                                            <label for="tanggal_kirim_berkas_faskes">Tanggal Kirim Berkas Fasyankes</label>

                                            <input type="text" name="tanggal_kirim_berkas_faskes" id="tanggal_kirim_berkas_faskes" value="<?= (!empty($data[0]['tgl_edit_berkas']) ? $data[0]['tgl_edit_berkas'] : '') ?>" class="form-control datepicker" autocomplete="off" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-4">
                                        <div class="form-group" style='display:block;'>
                                            <label for="tanggal_periksa_berkas_2">Tanggal Periksa Berkas</label>

                                            <input type="text" name="tanggal_periksa_berkas_2" id="tanggal_periksa_berkas_2" value="<?= (!empty($data[0]['tgl_periksa_berkas']) ? $data[0]['tgl_periksa_berkas'] : '') ?>" class="form-control datepicker" autocomplete="off" disabled>
                                        </div>
                                    </div>
                                ...
                                <div class="container mb-4">
                                    <div class="page-body">
                                        ...
                                        ?>
                                            ...
                                            <form role="form" method="post" class="login-form" name="form_valdation">
                                                <div class="form-group">
                                                    <span>Dokumen Kontrak </span><small class="text-muted"><a href="<?php echo base_url('assets/uploads/template/Dokumen_kontrak.docx'); ?>" target="_blank" href=""> Download Contoh</a> </i></small>
                                                    <?php
                                                ...
                                                <div class="form-group">
                                                    <span>Link Dokumen Pendukung Elemen Penilaian (EP)</span>
                                                    <fieldset>
                                                ...
                                                <div class="form-group col-md-12">
                                                    <div class="row">
                                                        <div class="form-group col-md-3">
                                                            ...
                                                            <span>Nama Surveior 1</span>
                                                            <input class="form-check-input" type="radio" value="jabatansurveior1" name="jabatan" id="jabatansurveior1" disabled readonly <?= $ischeck ?>>
                                                            <label class="form-check-label" id="labeljabatan1" for="jabatansurveior1">
                                                                <?= $status1 ?>
                                                            </label>
                                                        ...
                                                        ?>
                                                            <div class="col-md-2">
                                                                <input type="checkbox" name="approvements1" id="approvements1" disabled>
                                                                <label for="approvements1">Tidak Bersedia</label>
                                                            </div>
                                                            <div class="col-md-4 hideform" id="formpengganti1">
                                                                <label for="penggantis1">Nama Surveior Pengganti</label>
                                                ...
                                                <div class="form-group col-md-12">
                                                    <div class="row">
                                                        <div class="form-group col-md-3">
                                                            ...
                                                            <span>Nama Surveior 2</span>
                                                            <input class="form-check-input" type="radio" value="jabatansurveior2" name="jabatan" id="jabatansurveior2" disabled readonly <?= $ischeck2 ?>>
                                                            <label class="form-check-label" id="labeljabatan2" for="jabatansurveior2">
                                                                <?= $status2 ?>
                                                            </label>
                                                        ...
                                                        ?>
                                                            <div class="col-md-2">
                                                                <input type="checkbox" name="approvements2" id="approvements2" disabled>
                                                                <label for="approvements2">Tidak Bersedia</label>
                                                            </div>
                                                            <div class="col-md-4 hideform" id="formpengganti2">
                                                                <label for="penggantis2">Nama Surveior Pengganti</label>
                                ...
                                <div class="section">
                                    <div class="row">
                                        ...
                                        ?>
                                            <div class="form-group col-md-4">
                                                <div class="form-group" style='display:block;'>
                                                    <label for="tanggal_survei_hari">Tanggal Survei Hari <?= $namajumlah ?></label>
                                                    <input type="date" value="<?= $datab['tanggal_survei'] ?>" id="tanggal_survei_hari" class="form-control datepicker" autocomplete="off" readonly>
                                                </div>
                                                <div class="form-group" style='display:block;'>
                                                    <span>Foto Bukti Survei Hari <?= $namajumlah ?></span>
                                                    <i><small class="text-muted"> Maks 2MB </i></small>
                                                    <fieldset>
                                                        <div class="input-group">
                                                            <a class="btn btn-success rounded-pill" id="foto_bukti_survei" target="_blank" href="<?php echo $url_bukti; ?>">Lihat Dokumen</a>
                                                        </div>
                                                    </fieldset>
                                                </div>
                                            </div>
...
<script>
    ...
    async function getDataASPAK() {
        <?php
        if ($data[0]['jenis_fasyankes'] == 2) {
            $apiCode = isset($puskesmas->kode_sarana) ? $puskesmas->kode_sarana : '-1';
        } else {
        ...
        try {
            ...
            const getDataAspak = await fetch(`<?= base_url('pengajuan/getAspak') ?>?kode_faskes=${kodeFaskes}`, {
                method: 'GET'
            });
    ...
    // const response = await fetch(`<?php //base_url('pengajuan/getAspakId') 
                                        ?>?code=${code}`, {
    //             method: 'GET'
    //         });
    //         const data = await response.json();

    // const getDataAspak = await fetch(`<?php //php base_url('pengajuan/getAspak') 
                                            ?>?kode_integrasi=${kodeIntegrasi}&kode_faskes=${kodeFaskes}`, {
    //             method: 'GET'
    //         });
