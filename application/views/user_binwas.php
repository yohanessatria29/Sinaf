...
<head>
    ...
    <title>Rekomendasi Akreditasi Binwas</title>
                                ...
                                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                    <div class="card">
                                        ...
                                        <div class="form-group row align-items-center">
                                            <?php echo form_open_multipart('Binwas') ?>
                                        ...
                                        <div class="buttons">
                                            ...
                                            <a href="<?php echo base_url('binwas/'); ?>" class="btn btn-light rounded-pill">Bersihkan</a>
                                        </div>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="buttons">
                                                                            <a href="<?php echo base_url('binwas/detail/') . $value['id']; ?>" class="btn icon btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit">
