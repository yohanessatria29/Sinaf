    ...
    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
        <div class="page-heading">
            ...
            <?php
                    ...
                    <?php echo form_open_multipart('surveior/epsurveior2/'.$id) ?>
                ...
                <table class="table table-striped" id="table1">
                    ...
                    <?php
                        ...
                        ?>
                                ...
                                <td><input type="text" class="form-control" id="presentase_capaian_surveior<?=$n?>" name="presentase_capaian_surveior" value="<?=(!empty($trans[$key]['persentase_capaian_surveior']) ? $trans[$key]['persentase_capaian_surveior'] : '')?>" readonly></td>
        ...
        <div class="row">
            ...
            <div class="form-group col-md-4">
                ...
                <div class="form-group" style='display:block;'>
                    ...
                    <input type="date"  name="tanggal_survei" id="tanggal_survei" value=""  class="form-control datepicker"  autocomplete="off"  >
                </div>
                <div class="form-group" style='display:block;'>
            ...
            <div class="form-group col-md-4">
                ...
                <div class="form-group" style='display:block;'>
                    ...
                    <!-- <input type="date" class="form-control" id="disabledInput" placeholder="Disabled Text"> -->
                    <input type="date"  name="tanggal_survei2" id="tanggal_survei2" value=""  class="form-control datepicker"  autocomplete="off"  >
                </div>
                <div class="form-group" style='display:block;'>
            ...
            <div class="form-group col-md-4">
                ...
                <div class="form-group" style='display:block;'>
                    ...
                    <!-- <input type="date" class="form-control" id="disabledInput" placeholder="Disabled Text"> -->
                    <input type="date"  name="tanggal_survei3" id="tanggal_survei3" value=""  class="form-control datepicker"  autocomplete="off"  >
                </div>
                <div class="form-group" style='display:block;'>
