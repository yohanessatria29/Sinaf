                            ...
                            <div class="tab-content" id="myTabContent">
                                ...
                                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                    <div class="card">
                                        ...
                                        <?php echo form_open_multipart('Kemenkes/surveior')
                                        ?>
                                        <form role="form" method="post" class="login-form" name="form_valdation">
                                            ...
                                            <div class="form-group row align-items-center">
                                                ...
                                                <div class="col-lg-10 col-9">
                                                    ...
                                                    <?= form_dropdown('status', array('' => 'ALL', 'PNS' => 'PNS', 'Swasta' => 'Swasta', 'Purna Tugas' => 'Purna Tugas'), $keaktifan, 'id="keaktifan"  class="form-select"'); ?>
                                                    <?php //var_dump($data);
                                                    ?>
                                                </div>
                                            </div>
                                            <div class="buttons">
                                                ...
                                                <a href="<?php echo base_url('kemenkes/surveior'); ?>" class="btn btn-light rounded-pill">Bersihkan</a>
                                            </div>
                                        ...
                                        <!-- <div class="buttons">
                                            <a href="<?php // echo base_url() 
                                                        ?>pengajuan/inputsurveior" class="btn btn-success rounded-pill">Input Surveior</a>
                                        </div> -->
                                        <div class="card-body">
                                            <div class="row">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="buttons">
                                                                            <a href="<?php echo base_url('kemenkes/editsurveior/') . $data['id']; ?>" class="btn icon btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit">
                                                                                    <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                                                                                    <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                                                                                </svg></a>
                                                                            <!-- <a href="<?php // echo base_url('pengajuan/hapussurveior/') . $data['users_id'] . '/' . $data['no_hp']; 
                                                                                            ?>" onclick="return confirm('Apa Anda Yakin Ingin Menghapusnya?')" class="btn icon btn-danger">Delete</a> -->
