                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 mb-1">
                            <p>Dokumen Sertifikat/Surat Keterangan Tidak Lulus</p>
                                <fieldset>
                                    <div class="input-group">
                                        <input type="file" class="form-control" id="url_dokumen_sertifikat" name="url_dokumen_sertifikat"
                                    ...
                                    <?php 
                                        if(!empty($data[0]['url_dokumen_sertifikat'])) {
                                            ...
                                            ?>
                                        <a class="btn btn-success rounded-pill" target="_blank" href="<?php echo $url_dokumen_sertifikat ;?>">Lihat Dokumen</a>
                                        <?php
                                        } else {
