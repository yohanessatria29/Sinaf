                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <div class="form-group" style='display:block;'>
                                    ...
                                    <fieldset>
                                        <div class="input-group">
                                            <input type="file" class="form-control" id="url_surat_rekomendasi_status" name="url_surat_rekomendasi_status" aria-describedby="inputGroupFileAddon04" aria-label="Upload" required>
            ...
            <section class="section">
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php echo form_open_multipart('Admin/detail/' . $id) ?>
                            ...
                            <table class="table table-striped" id="table1">
                                ...
                                <tbody>
                                    ...
                                    foreach ($datab as $datab) {
                                        $key = $datab['id'];    //echo $data['status_final_ep_verifikator'];
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            ?>
                                <textarea type="text" id="catatan_ketua" name="catatan_ketua" class="form-control" style="display;" disabled><?= $data[0]['catatan_ketua']; ?></textarea>
                            <?php
                            } else { ?>
                        ...
                        <div class="form-group">
                            <div class="alert alert-primary col-4 col-md-4 col-lg-4">
                                <label for="helperText">Catatan Direktur Mutu</label>
                            </div>
                            <?php
                            // var_dump($data[0]);
                            if (!empty($data[0]['catatan_direktur'])) {
                                //$catatan_ketua = $data[0]['catatan_ketua'];
                            ?>
                                <textarea type="text" id="catatan_direktur" name="catatan_direktur" class="form-control" style="display;" disabled><?= $data[0]['catatan_direktur']; ?></textarea>
                            <?php
                            } else { ?>
