...
<head>
    ...
    <title>User Direktur Mutu</title>
        ...
        <div class="container">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Input Data Direktur</h4>
                </div>
                <?php echo form_open_multipart('User/simpanDirektur') ?>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nik" name="nik" placeholder="Masukkan NIK" onchange="checknik(this.value, this.id)" required>
                                </div>
                                <div class="form-group">
