...
<body>
        ...
        <div class="container">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Input Data Binwas</h4>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nik" name="nik" placeholder="Masukkan NIK" onchange="checkniksurveior(this.value, this.id)" required>
                                </div>
                                <div class="form-group">
    ...
    <script>
        ...
        function checkniksurveior(val, inputbox) {
            ...
            $.ajax({
                url: base_url + '/user/checkniksurveior/' + username,
                type: 'get',
                success: function(response) {
                    // alert(response);
                    $(this).val = "";
