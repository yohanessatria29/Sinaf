                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <?= form_dropdown('lpa_id', dropdown_sina_lpa(), $data[0]['lpa_id'], 'id="lpa_id"  class="form-control" disabled'); ?>
                                                                </div>
                            ...
                            <tbody>
                                <tr>
                                    <td><?php
                                        ...
                                        ?>
                                        <a target="_blank" href="http://103.74.143.45/FasyankesOnline/Viewonly/dfo/<?= $data[0]['fasyankes_id']; ?>/<?= $data[0]['jenis_fasyankes']; ?>">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><textarea style="display:<?= $kelengkapan_sarpras_alkes_checked; ?>;" class="form-control" rows="3" cols="70" id="kelengkapan_sarpras_alkes_catatan" name="kelengkapan_sarpras_alkes_catatan" value="<?= $data[0]['kelengkapan_sarpras_alkes_catatan']; ?>"><?= $data[0]['kelengkapan_sarpras_alkes_catatan']; ?></textarea>
                                    ...
                                    <!-- <input type="text" class="form-control" style="display:<?= $kelengkapan_sarpras_alkes_checked; ?>" id="kelengkapan_sarpras_alkes_catatan" name="kelengkapan_sarpras_alkes_catatan" value="<?= $data[0]['kelengkapan_sarpras_alkes_catatan']; ?>"> -->
                                </td>
                            </tr>
                            <tr>
                                <td>4</td>
                                ...
                                <td>
                                    ...
                                    <!-- <input type="text" class="form-control" style="display:<?= $kelengkapan_nakes_checked; ?>" id="kelengkapan_nakes_catatan" name="kelengkapan_nakes_catatan" value="<?= $data[0]['kelengkapan_nakes_catatan']; ?>"> -->
                                </td>
                            </tr>
                            <tr>
                                <td>5</td>
                                ...
                                <td>
                                    ...
                                    <!-- <input type="text" class="form-control" style="display:<?= $kelengkapan_laporan_inm_checked; ?> " id="kelengkapan_laporan_inm_catatan" name="kelengkapan_laporan_inm_catatan" value="<?= $data[0]['kelengkapan_laporan_inm_catatan']; ?>"> -->
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!-- <input type="text" class="form-control" style="display:<?= $kelengkapan_laporan_ikp_checked; ?>" id="kelengkapan_laporan_ikp_catatan" name="kelengkapan_laporan_ikp_catatan" value="<?= $data[0]['kelengkapan_laporan_ikp_catatan']; ?>"> -->
                                </td>
                            </tr>
                        </tbody>
                    </table>
        ...
        <div class="col-md-12 mb-1">
            ...
            <form role="form" method="post" class="login-form" name="form_valdation">
                ...
                <!-- <div class="form-group">
                        ...
                        <input type="text"  name="tanggal_survei" id="tanggal_survei" value="<?php //$tanggal_survei 
                                                                                                ?>"  class="form-control datepicker"  autocomplete="off" required >
                        <div class="row">
                            <div class="col-md-4">
                                <input type="date" name="tanggal_awal" id="tanggal_awal" class="form-control" value="<?php //$data[0]['tanggal_awal_rencana_survei'] 
                                                                                                                        ?>" disabled>
                            </div>
                            s.d.
                            <div class="col-md-4">
                                <input type="date" name="tanggal_akhir" id="tanggal_akhir" class="form-control" value="<?php //$data[0]['tanggal_akhir_rencana_survei'] 
                                                                                                                        ?>" disabled>
                            </div>
                        </div>
                    </div> -->
                ...
                if ($data[0]['jenis_survei_id'] == 1) {
                    ...
                    //     $surveior_dua = $surveior_dua = $surveior[2]['users_id'];
                    //     $surveior_id_satu = $surveior[0]['user_surveior_id'];
                    //     $surveior_id_dua = $surveior[2]['user_surveior_id'];
                    // } else {
                    $surveior_satu = $surveior[0]['users_id'];
                ...
                <div class="form-group col-md-12">
                    <div class="row">
                        <div class="form-group col-md-3">
                            <?php
                            if (isset($surveior_lapangan[0]['id'])) {
                            ?>
                                <input hidden type="text" name="id_surveior_lapangan" id="id_surveior_lapangan" value="<?php echo $surveior_lapangan[0]['id'] ?>">
                            <?php
                            }
                            ?>
                            <label for="helperText">Nama Surveior 1 (Ketua)</label>

                            <?php
                            if (isset($data_surveior_lapangan) && $data_surveior_lapangan != NULL) {
                            ?>
                            ...
                            <input hidden type="text" name="surveior_satu" value="<?= $surveior_satu ?>" id="surveior_satu">
                            <input hidden type="text" name="status_surveior_satu" value="1" id="status_surveior_satu">
                            <input type="text" name="id_surveior_satu" id="id_surveior_satu" value="<?php echo $surveior_id_satu ?>" hidden>

                        </div>
                        <?php
                        if (isset($idsuveiorpengganti1)) {
                        ?>
                            <div class="col-md-2">
                            ...
                            <div class="col-md-3" id="formpenggantitext1">
                                ...
                                <textarea class="form-control" cols="20" disabled rows="2"><?php echo $keterangnapengganti1 ?></textarea>
                            </div>
                        <?php
                        } else {
                        ?>
                ...
                <div class="form-group col-md-12">
                    <div class="row">
                        <div class="form-group col-md-3">
                            <label for="helperText">Nama Surveior 2 (Anggota)</label>
                            <?php
                            if (isset($data_surveior_lapangan) && $data_surveior_lapangan != NULL) {
                            ?>
                            ...
                            ?>
                            <input hidden type="text" name="surveior_dua" value="<?= $surveior_dua ?>" id="surveior_dua">
                            <input hidden type="text" name="status_surveior_dua" value="2" id="status_surveior_dua">
                            <input type="text" name="id_surveior_dua" id="id_surveior_dua" value="<?php echo $surveior_id_dua ?>" hidden>
                        </div>

                        <?php
                        if (isset($idsuveiorpengganti2)) {
                        ?>
                            <div class="col-md-2">
                            ...
                            <div class="col-md-3" id="formpenggantitext1">
                                ...
                                <textarea class="form-control" cols="20" disabled rows="2"><?php echo $keterangnapengganti2 ?></textarea>
                            </div>
                        <?php
                        } else {
                        ?>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>Sertifikat</td>
                                <td>
                                    <!-- <a class="btn btn-primary rounded-pill" target="_blank" href="<?php //echo $data[0]['url_dokumen_sertifikat'] 
                                                                                                        ?>">Lihat Dokumen</a> -->
...
<script>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(JSON.parse(response), function() {
                        $("#penggantis1").append('<option value="' + this.userSurveiorId + '">' + this.surveior_nama + ' - ' + this.propinsi_name + '</option>')
                    })
                }
            })
        } else {
        ...
        if (checkBox.checked == true) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(JSON.parse(response), function() {
                        $("#penggantis2").append('<option value="' + this.userSurveiorId + '">' + this.surveior_nama + ' - ' + this.propinsi_name + '</option>')
                    })
                }
            })
        } else {
    ...
    //var msg = surveior_satu+' sudah sebagai Ketua. Silakan pilih user yang lain.';
    ...
    async function getDataASPAK() {
        ...
        try {
            ...
            if (datas === undefined || datas.length == 0) {
                rows += '<tr><th colspan="2" class="text-center">Belum ada data.</th></tr>';
